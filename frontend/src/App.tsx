...
function App() {
  ...
  const getNavButtonClass = (page: Page) => {
    ...
    const activeClass = darkMode ? 'bg-blue-600 text-white' : 'bg-blue-500 text-white'
    const inactiveClass = darkMode ? 'hover:bg-slate-700 text-gray-300' : 'hover:bg-gray-100 text-slate-700'
    return `px-4 py-2 rounded-lg transition-colors ${isActive ? activeClass : inactiveClass}`
  }
        ...
        <div className="container mx-auto px-4 py-4 flex gap-4 items-center justify-between">
          <div className="flex gap-4">
            ...
            <button
              ...
              className={getNavButtonClass('analysis')}
            >
              Analysis
            </button>
          </div>
